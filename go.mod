module github.com/curtisnewbie/miso-agent
...
require (
	...
	github.com/curtisnewbie/miso v0.4.12-0.20260120081926-5532113bb9b3
	github.com/curtisnewbie/miso-tavily v0.0.0-20260122055311-4a748287d499
)
